...
set dev_meta="http://10.110.233.102/apollo"
set fat_meta="http://someIp:8080"
set uat_meta="http://10.110.233.102/apollo"
...
rem call mvn clean package -DskipTests -pl apollo-configservice -am -Dapollo_profile=github -Dspring_datasource_url=%apollo_config_db_url% -Dspring_datasource_username=%apollo_config_db_username% -Dspring_datasource_password=%apollo_config_db_password%
...
echo "==== building admin-service finished ===="
